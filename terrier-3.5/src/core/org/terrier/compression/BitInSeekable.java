 ...
 * Each method returns a {@link org.terrier.compression.BitIn} implementation
 * that allows access to the encoded integers. Several implementations exist:
 * <ul>
 * <li>{@link org.terrier.compression.BitFileBuffered} - buffers an amount of data starting that the specified offset.</li>
 * <li>{@link org.terrier.compression.BitFile} - buffers the pre-specified amount starting and ending as specified. This implementation can also be used for reading. This class is deprecated.</li> 
 * <li>{@link org.terrier.compression.BitFileInMemory} - reads the entire file into memory. File must be less than Integer.MAX_VALUE (2GB).</li>
 * <li>{@link org.terrier.compression.BitFileInMemoryLarge} - reads the entire file into memory. File size only constrained by available memory.</li>
 * </ul>
 * @author Craig Macdonald
  * @since 2.0
 * @see org.terrier.compression.BitFileBuffered
 * @see org.terrier.compression.BitOut
 * @see org.terrier.compression.BitIn
 */
